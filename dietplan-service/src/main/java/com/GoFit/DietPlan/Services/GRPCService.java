        ...
        try{
          ...
          /*  ManagedChannel channel = ManagedChannelBuilder.forAddress("localhost",9090)
            ...
            EventResponse response=stub.save(EventRequest.newBuilder()
                    ...
                    .setMicroservice("dietplan-service")
                    .setActionType(eventType)
                    .setResourceName(resourceName)
                    .setResponseType(responseType)
                    .build());
            System.out.println("timestamp: "+newTime+", microservice: "+"dietplan-service"+", actionType: "+eventType+", resourceName: "+resourceName+", responseType "+
                    responseType);
        }
